...
export class GrokService implements OnModuleInit {
  ...
  private systemPrompt(): string {
    ...
    return [
      ...
      '- As soon as you have settled on the final menu, call build_quote with those exact product_id values and quantities',
      '  BEFORE writing your summary. This gives the customer an "Add all to cart" button with real prices. Then present the',
      '  menu in your words. If they tweak the menu, call build_quote again with the updated items.',
