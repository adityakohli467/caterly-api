--
-- Admin User Setup for Login
-- Login Credentials:
--   Username: superadmin
--   Password: admin
--   Email: superadmin@stdreux.com
...
-- Insert admin user
-- Using the password hash from your existing data (password: 'admin')
INSERT INTO public."user" (
    ...
    'superadmin@stdreux.com',
    'Super Admin',
    'superadmin',
    '$2b$10$8MAAwoiaUFIRhFuRvZ21ue3r7f1Cs/.mBpefeaBMKAkTwS5F.gS6K', -- password: 'admin'
